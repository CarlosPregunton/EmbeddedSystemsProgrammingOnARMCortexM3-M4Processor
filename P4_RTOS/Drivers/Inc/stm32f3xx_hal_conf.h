...
/*
  Habilita interrupciones de núcleo y control de NVIC. No es esencial para 
  este programa simple, pero si estás utilizando HAL_Delay, déjalo activado.
*/
...
/*
  ...
  de reloj y habilitar el reloj del GPIO.
*/
